...
public class ClinicDaoImpl implements ClinicDAO {
	...
	public int updatePsd(Clinic clinic) {
		...
		hql.append("clinicName = :clinicName, ").append("updateId = :updateId, ")
				.append("updateTime = CURRENT_TIMESTAMP ").append("WHERE account = :account");
		...
		query.setParameter("clinicName", clinic.getClinicName()).setParameter("updateId", clinic.getUpdateId())
